...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    ...
    this.stripe = Stripe('pk_test_51HKQFXFHCSpgc7YYBoZ5slXCabqJkUws5qkLmLGvwRG4zoCDPQqFG0LLv2r76l463QcBVXuO0ES8ROFfcc5J6v4O007w6jT1N9');
  ...
  async submitOrder(){
    ...
    try {
      ...
      if(paymentResult.paymentIntent){
        this.basketSerivce.deleteBasket(basket);
